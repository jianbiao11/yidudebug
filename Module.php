...
class Module extends \yii\base\Module implements BootstrapInterface {
	...
	public function bootstrap($app) {
		...
		if ($this->logTargetClass) {
			$class = new \ReflectionClass($this->logTargetClass);
			$instance_loger = $class->newInstanceArgs([$this]);
			$this->logTarget = Yii::$app->getLog()->targets['debug'] = $instance_loger;
		} else {
